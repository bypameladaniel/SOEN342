...
public class Main {
    public static void main(String[] var0) throws Exception {
        ...
        List<Object> result = new ArrayList<>(TripUtils.getSpecitficConnections(sq, connectionDB.getAllConnections()));
    ...
    public void tests(ConnectionDB connectionDB, CityDB cityDB){
        ...
        List<Trip> trips = TripUtils.findIndirectTrips("Bergen", "Turku", cityDB);
